...
public class HelloJavaBean implements Hello, ServiceLifecycle
{
   ...
   { 
      ...
      SOAPMessageContext msgContext = (SOAPMessageContext)servletEndpointContext.getMessageContext();
      MimeHeaders mimeHeaders = msgContext.getMessage().getMimeHeaders();
      log.info(mimeHeaders);

      String soapAction = mimeHeaders.getHeader("SOAPAction")[0];
      return soapAction;
   }
