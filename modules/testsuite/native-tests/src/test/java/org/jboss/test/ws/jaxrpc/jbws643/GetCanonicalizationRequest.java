...
public class GetCanonicalizationRequest
{
   ...
   public GetCanonicalizationRequest()
   {
   }

   public GetCanonicalizationRequest(java.lang.String[] ns1Keyword, java.lang.String ns1Market)
   {
