...
public class GetKeywordsBySubphraseRequest
{
   ...
   public GetKeywordsBySubphraseRequest()
   {
   }

   public GetKeywordsBySubphraseRequest(java.lang.String ns1Market, java.lang.String ns1Keyword)
   {
